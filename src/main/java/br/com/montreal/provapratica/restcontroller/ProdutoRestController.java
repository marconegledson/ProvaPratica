...
public class ProdutoRestController {
	...
	public Produto restGet(	@PathVariable(name = "idProduto", required = true) Long idProduto, 
	...
	public List<Produto> restGetByProdutoPai(@PathVariable(name = "idProdutoPai", required = true) Long idProdutoPai) {
	...
	public List<Imagem> restImagemListByIdProduto(@PathVariable(name = "idProduto", required = true) Long idProduto) {
