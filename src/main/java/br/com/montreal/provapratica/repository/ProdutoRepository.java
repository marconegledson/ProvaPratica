...
public interface ProdutoRepository extends JpaRepository<Produto, Long>{
	...
	@Query("Select Distinct p From Produto p Left Join Fetch p.imagens i Order by p.id")
	public List<Produto> findFetchedAll();
	
	@Query("Select Distinct p From Produto p Left Join Fetch p.imagens Where p.id = :idProduto")
